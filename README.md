...
<p align="center">
  <img src="screenshots/panel.png" alt="面板详情" width="40%">
</p>
...
1. 直接下载：[**SeekBalance-1.1-arm64.dmg**](https://github.com/VincentPhoton/SeekBalance/releases/latest/download/SeekBalance-1.1-arm64.dmg)（或到 [Releases](../../releases) 页面下载）
...
| 花费 | 按**每次请求的实际时间**精确计价（8/17 前老价；之后按高峰 9:00–12:00、14:00–18:00 / 空闲价） | **仅本机，非官方账单** |
